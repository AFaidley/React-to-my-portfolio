  ...
  return (
    <div className='App text-center flexcont'>
      ...
      <div className='projects'>
        <h1>
          <a id='projlinks' href={props.sevenLive}>
            {props.seven}
          </a>
        </h1>
      ...
      <div className='projects'>
        <h1>
          <a id='projlinks' href={props.oneLive}>
            {props.one}
          </a>
        </h1>
      ...
      <div className='projects'>
        <h1>
          <a id='projlinks' href={props.twoLive}>
            {props.two}
          </a>
        </h1>
      ...
      <div className='projects'>
        <h1>
          <a id='projlinks' href={props.fourLive}>
            {props.four}
          </a>
        </h1>
      ...
      <div className='projects'>
        <h1>
          <a id='projlinks' href={props.fiveLive}>
            {props.five}
          </a>
        </h1>
      ...
      <div className='projects'>
        <h1>
          <a id='projlinks' href={props.sixLive}>
            {props.six}
          </a>
        </h1>
